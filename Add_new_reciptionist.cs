...
{
    public partial class Add_new_reciptionist : Form
    {
        Doctor_controller control_object;
        public Add_new_reciptionist()
        {
            InitializeComponent();
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            else if (Convert.ToInt32(textBox4.Text) / 1000 != 12)
            ...
            else
            {
                ...
                if (check > 0)
                {
                    MessageBox.Show("A new Receptionist is added successfully");
                    textBox1.Clear();
                    textBox2.Clear();
                    textBox3.Clear();
                    textBox4.Clear();
                    ...
                    MessageBox.Show("Error!Cannot add the new Receptionist");
            }
        }
    }
}
